...
app.get("/getAllData", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengambil semua data menu
  await menu
...
// get data by id menu
app.get("/getById/:id", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengambil data menu berdasarkan id menu
  await menu
...
// create menu
app.post("/create", upload.single("gambar"), auth, checkRole('admin'), async (req, res) => { // endpoint untuk menambahkan data menu
...
// delete menu
app.delete("/delete/:id_menu", auth, checkRole('admin'), async (req, res) => { // endpoint untuk menghapus data menu
...
// edit menu
app.patch("/edit/:id_menu", upload.single("gambar"), auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengubah data menu
  const param = { id_menu: req.params.id_menu }; // inisialisasi parameter yang akan dikirimkan melalui parameter
...
// mencari menu
app.get("/search/:nama_menu", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mencari data menu berdasarkan nama menu
  menu 
