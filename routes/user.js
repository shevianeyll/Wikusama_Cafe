...
// get all data user
app.get("/getAllData", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengambil semua data user
  await user
...
// get data by id user
app.get("/getById/:id", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengambil data user berdasarkan id user
  await user
...
// get data by role
app.get("/getByRole/:role", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengambil data user berdasarkan role
  await user
...
// register
app.post("/register", auth, checkRole('admin'), async (req, res) => { // endpoint untuk registrasi user
...
// delete user
app.delete("/delete/:id_user", auth, checkRole('admin'), async (req, res) => { // endpoint untuk menghapus data user berdasarkan id user
...
// edit user
app.patch("/edit/:id_user", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mengubah data user berdasarkan id user
...
// search user
app.get("/search/:nama_user", auth, checkRole('admin'), async (req, res) => { // endpoint untuk mencari data user berdasarkan nama user
  user 
