...
app.get("/getAllData",  async (req, res) => { // endpoint untuk mengambil semua data detail_transaksi
...
app.post("/create", auth, async (req, res) => { // endpoint untuk menambahkan data detail_transaksi
